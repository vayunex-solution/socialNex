...
/* Platform SVG Icons */
const platforms = [
    { name: 'Bluesky', icon: <PlatformIcon platform="bluesky" colored={true} size={32} />, status: 'live', color: '#0085FF' },
    { name: 'LinkedIn', icon: <PlatformIcon platform="linkedin" colored={true} size={32} />, status: 'live', color: '#0A66C2' },
    { name: 'Telegram', icon: <PlatformIcon platform="telegram" colored={true} size={32} />, status: 'live', color: '#26A5E4' },
    { name: 'Discord', icon: <PlatformIcon platform="discord" colored={true} size={32} />, status: 'live', color: '#5865F2' },
    { name: 'Facebook', icon: <PlatformIcon platform="facebook" colored={true} size={32} />, status: 'live', color: '#1877F2' },
    { name: 'Instagram', icon: <PlatformIcon platform="instagram" colored={true} size={32} />, status: 'live', color: '#E4405F' },
    { name: 'Twitter/X', icon: <PlatformIcon platform="x" colored={true} size={32} />, status: 'soon', color: '#000' },
    { name: 'YouTube', icon: <PlatformIcon platform="youtube" colored={true} size={32} />, status: 'soon', color: '#FF0000' },
    { name: 'TikTok', icon: '🎵', status: 'soon', color: '#000' },
]
...
const faqs = [
    ...
    { q: 'Which platforms do you support?', a: 'Currently live: Bluesky, LinkedIn, Telegram, Discord, Facebook & Instagram (Posts, Stories, Reels). Twitter/X, YouTube & TikTok coming soon!' },
